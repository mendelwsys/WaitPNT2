...
Для сборки приложения можно воспользоваться ant (версия > 1.6) для этого необходимо прописать jdk.home.1.6 и idea.home в файле waitpnt2.properties, запуск сборки bld.cmd
