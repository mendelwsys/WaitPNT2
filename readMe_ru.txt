...
Демо ролик на русском языке можно посмотреть по адресу https://drive.google.com/drive/folders/1iFJvMIJ0lAJC5YY370k2FpXjL1MoZ6Vb?usp=sharing (ИЛИ https://cloud.mail.ru/public/X4M1/PnE9qDFrv)
...
Для запуска приложений необходимо прописать путь в файлах *Demo к Java (только 32-х разрядная версия >=1.6), скачать информацию для отображения по ссылке https://drive.google.com/file/d/1_ERxjg8uI_nx2l9DGG5InJEyJ_ZpAs-T/view?usp=sharing (ИЛИ https://cloud.mail.ru/public/Rpfi/5PPhHhrSB)  и распаковать архив  в папку ToyGIS. Вся информация после этого должна находится в папке  ToyGIS/MAPDIR.
