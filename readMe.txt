...
Приложение для отображения объектов ЖД отображает табличную информацию вместе с картографической, позволяет делать простые операции выделения объектов по критерию, по попадаю в область интереса, а так же  демонстрирует возможность визуализации количественного параметра объектов поверх карты.   
