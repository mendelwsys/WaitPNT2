...
To build the application, you can use ant (version> 1.6), for this you need to set jdk.home.1.6 and idea.home in the waitpnt2.properties file, run the build bld.cmd
